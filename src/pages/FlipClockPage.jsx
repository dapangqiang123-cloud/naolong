    ...
    <div className="relative min-h-screen bg-[#131313] text-[#e2e2e2] overflow-hidden flex flex-col">
      ...
      <header className="relative z-10 bg-[#131313] flex justify-between items-center px-6 h-16 w-full">
        ...
        <nav className="flex gap-8">
          <button onClick={() => setCurrentView(VIEWS.POMODORO)} className="font-['Space_Grotesk'] font-bold tracking-tight text-[#c6c8ba] hover:text-white transition-colors">番茄钟</button>
          <button className="font-['Space_Grotesk'] font-bold tracking-tight text-[#bdcd9a] border-b-2 border-[#bdcd9a] pb-1">时钟</button>
          <button onClick={() => setCurrentView(VIEWS.SLEEP_SETUP)} className="font-['Space_Grotesk'] font-bold tracking-tight text-[#c6c8ba] hover:text-white transition-colors">快眠</button>
        </nav>
      ...
      <main className="relative z-10 flex-1 flex flex-col items-center justify-center px-8">
        ...
        <div className="flex items-center gap-4 md:gap-8">
          ...
          <div className="flex flex-col gap-4 mb-1">
            <div className="w-3 h-3 bg-[#bdcd9a] rounded-full" />
            <div className="w-3 h-3 bg-[#bdcd9a] rounded-full" />
          </div>
          <div className="flex gap-2">
            <FlipDigit value={m0} />
          ...
          <div className="flex flex-col gap-4 mb-1">
            <div className="w-2 h-2 bg-[#45483e] rounded-full" />
            <div className="w-2 h-2 bg-[#45483e] rounded-full" />
          </div>
          <div className="flex gap-2">
        ...
        <div className="mt-6 flex items-center gap-3">
          <span className={`font-['Space_Grotesk'] text-sm font-bold tracking-[0.3em] transition-colors ${ampm==='AM'?'text-[#bdcd9a]':'text-[#45483e]'}`}>AM</span>
          <div className="w-px h-4 bg-[#45483e]" />
          <span className={`font-['Space_Grotesk'] text-sm font-bold tracking-[0.3em] transition-colors ${ampm==='PM'?'text-[#bdcd9a]':'text-[#45483e]'}`}>PM</span>
        </div>
        <div className="mt-12 text-center">
          <p className="font-['Space_Grotesk'] text-[#c6c8ba] uppercase tracking-[0.2em] text-xs mb-2">Current Session</p>
          <h2 className="font-['Space_Grotesk'] text-2xl font-bold text-white">Deep Work Phase</h2>
        </div>
      </main>
    </div>
  )
